...
//        private Cell[][] cells; //celdas que serán el "panel" para generar el laberinto
//
//        public GenerateMaze(int mazeRows, int mazeColumns, int cellsWidth, Cell[][] cells) {
...
//                cells = new Cell[this.mazeColumns][this.mazeRows]; //celdas generadas  con respeto a las columnas y filas ingresdasporel ususario
//                for (int i = 0; i < this.mazeRows; i++) {
//                        for (int j = 0; j < this.mazeColumns; j++) {
//                                cells[i][j] = new Cell(j, i, this.cellsWidth); //las celdas se ubican en su coordenada y anchura indicada
//                        }
//                }
//                this.adjacentCells();
//        }
